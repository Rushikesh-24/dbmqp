              ...
              <div className="flex items-start gap-3">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-xs text-orange-700 mb-3">
                    Explore a fully setup restaurant with sample data
                  </p>
                  ...
                  <button
                    ...
                    disabled={loading}
                    className="w-full bg-orange-500 text-white hover:bg-orange-600 disabled:opacity-50 disabled:cursor-not-allowed transition-all py-2 px-4 rounded-md text-sm font-semibold"
                  >
      ...
      <div className="hidden md:flex w-1/2 bg-gradient-to-br from-orange-500 to-orange-600 items-center justify-center relative overflow-hidden">
        ...
        <div className="relative z-10 text-center text-white px-8">
          ...
          <p className="text-lg text-orange-100 max-w-sm">
            Manage your restaurant with ease. Real-time orders, kitchen
            management, and customer insights all in one place.
          </p>
        </div>
      </div>
    </div>
