# **nomnom - Restaurant Order & Kitchen Display System**

> ⚠️ **Repository Note:** This repository currently contains the source code for the **Restaurant-Facing Kitchen Display System (KDS)** and the **Next.js Backend**. The **Customer-Facing Flutter application** is a separate, private repository and is not included here.
...
<p align="center">
  <img src="https://github.com/user-attachments/assets/0e55616f-2797-4dbf-a1e3-f1327d6da293" alt="Customer App View" width="45%" />
  &nbsp;
  <img src="https://github.com/user-attachments/assets/d2c942eb-22cb-43e9-a550-fb462ba91ecb" alt="Kitchen Display System View" width="45%" />
</p>

<p align="center">
  <img src="https://github.com/user-attachments/assets/254819d3-5098-4cbc-91b7-3e43677273b0" alt="Order Flow" width="45%" />
  &nbsp;
  <img src="https://github.com/user-attachments/assets/ee8923bf-71dc-41d9-a0c9-ba1c5c030f12" alt="Sales Dashboard" width="45%" />
</p>
...
### **Customer-Facing Application (Private Repository)**
...
### **Restaurant-Facing Kitchen Display System (Included in this repo)**
